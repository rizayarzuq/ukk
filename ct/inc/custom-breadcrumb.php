...
if (! function_exists('ct_corporate_breadcrumb')) {
	function ct_corporate_breadcrumb(){
        // Boxed or Fullwidth
        ...
        <?php }
            ...
            if ( !is_home() ) {
                ...
                elseif ( is_month() ) { echo '<span class="delimiter">Archive for '; echo get_the_date('F, Y'); echo'</span>'; }

                elseif ( is_year() ) { echo '<span class="delimiter">Archive for '; echo get_the_date('Y'); echo'</span>'; }
                  ...
                  elseif ( is_single() ) {
                    ...
                    echo '<span class="delimiter">';
                    echo esc_html__('Search Results for ','ct-corporate');
                    echo '<strong>';
                    echo get_search_query();
                    echo'</strong></span>';
                }  elseif ( is_404() ) {
                    echo '<span class="delimiter">';
                    echo esc_html__('404 - Page not found ','ct-corporate');
                    echo '</span>';
                } elseif ( is_day() ) {
                    echo '<span class="delimiter">';
                    echo esc_html__('Archive for ','ct-corporate');
                ...
                echo '<span class="delimiter"> ';
                    echo esc_html__('Author Archive ','ct-corporate');
                    the_author();
                echo'</span>';

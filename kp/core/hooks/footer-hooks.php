			...
			<footer class="site-footer">
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<div id="credit">
							<a href="<?php esc_url( __( '//cyberchimps.com/','cyberchimps_core' ) ); ?>" target="_blank" title="CyberChimps Themes" rel="noindex, nofollow">									
								<h4 class="cc-credit-text"><?php _e( 'CyberChimps WordPress Themes', 'cyberchimps_core' ); ?></h4>

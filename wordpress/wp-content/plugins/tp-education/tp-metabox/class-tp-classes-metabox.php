...
class TP_Education_Class_Metabox {
    ...
    public function tp_education_class_options( $post )
    {
        ...
        <select name="tp_class_period_value" id="class_period_id" >
            <option <?php echo ( $period == 'Per/Day' ) ? 'selected' : ''; ?>><?php _e( 'Per/Day', 'tp-education' ); ?></option>
            <option <?php echo ( $period == 'Per/Week' ) ? 'selected' : ''; ?>><?php _e( 'Per/Week', 'tp-education' ); ?></option>
            <option <?php echo ( $period == 'Per/Month' ) ? 'selected' : ''; ?>><?php _e( 'Per/Month', 'tp-education' ); ?></option>
            <option <?php echo ( $period == 'Per/Semester' ) ? 'selected' : ''; ?>><?php _e( 'Per/Semester', 'tp-education' ); ?></option>
            <option <?php echo ( $period == 'Per/Year' ) ? 'selected' : ''; ?>><?php _e( 'Per/Year', 'tp-education' ); ?></option>
        </select>

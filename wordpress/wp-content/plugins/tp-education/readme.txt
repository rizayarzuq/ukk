...
== Hooks ==
 	...
 	= Event Details =
	do_action( 'tp_event_date_action' ); // Event Date
	do_action( 'tp_event_start_time_action' ); // Event Start Time
	do_action( 'tp_event_end_time_action' ); // Event End Time
	do_action( 'tp_event_location_action' ); // Event Location

	= Class Details =
	do_action( 'tp_class_cost_action' ); // Class Cost
	do_action( 'tp_class_period_action' ); // Class Period
	do_action( 'tp_class_size_action' ); // Class Size
	do_action( 'tp_class_age_group_action' ); // Class Age Group

	= Excursion Details =
	do_action( 'tp_excursion_start_date_action' ); // Excursion Start Date
	do_action( 'tp_excursion_end_date_action' ); // Excursion End Date
	do_action( 'tp_excursion_location_action' ); // Excursion Location

	= Team Details =
	do_action( 'tp_team_designation_action' ); // Team Designation
	do_action( 'tp_team_email_action' ); // Team Email
	do_action( 'tp_team_phone_action' ); // Team Phone
	do_action( 'tp_team_skype_action' ); // Team Skype
	do_action( 'tp_team_website_action' ); // Team Website
	do_action( 'tp_team_courses_action' ); // Team Courses
	do_action( 'tp_team_social_action' ); // Team Social Links

	= Testimonial Details =
	do_action( 'tp_testimonial_rating_action' ); // Testimonial Rating
	do_action( 'tp_testimonial_designation_action' ); // Testimonial Designation
	do_action( 'tp_testimonial_social_action' ); // Testimonial Social Links

	= Course Details =
	do_action( 'tp_course_type_action' ); // Course Type
	do_action( 'tp_course_duration_action' ); // Course Duration
	do_action( 'tp_course_price_action' ); // Course Price
	do_action( 'tp_course_students_action' ); // Course no of Students
	do_action( 'tp_course_language_action' ); // Course Language
	do_action( 'tp_course_assessment_action' ); // Course Assessment
	do_action( 'tp_course_skills_action' ); // Course Skills
	do_action( 'tp_course_professor_action' ); // Course Professor
	do_action( 'tp_course_counselors_action' ); // Course Counselors

	= Affiliation Details =
	do_action( 'tp_affiliation_link_action' ); // Affiliation Link

...
<!-- header -->
		<header>
			<div class="wrapper">
				<h1>
					<a href="index.html" id="logo">Air Lines</a><span id="slogan">Book your seat</span>
				</h1>
				<div class="right">
					<nav>
						<ul id="top_nav">
...
<!-- content -->
	<section id="content">
		<article class="col1">
			<div class="pad_1">
				<h2>Perencana Penerbangan Anda</h2>
				<form id="form_1" action="" method="post">
					<div class="wrapper pad_bot1">
					</div>
					<div class="wrapper">
						Berangkat Dari:
						<div class="bg"><input type="text" name="berangkat" class="input input1" value="Enter City or Airport Code" onblur="if(this.value=='') this.value='Enter City or Airport Code'" onFocus="if(this.value =='Enter City or Airport Code' ) this.value=''"></div>
					</div>
					<div class="wrapper">
						Pergi Ke:
						<div class="bg"><input type="text" name="pergi" class="input input1" value="Enter City or Airport Code" onblur="if(this.value=='') this.value='Enter City or Airport Code'" onFocus="if(this.value =='Enter City or Airport Code' ) this.value=''"></div>
					</div>
					<div class="wrapper">
					    Tanggal dan Waktu Keberangkatan:
						<div class="wrapper">
							<div class="bg left"><input type="text" name="tanggal" class="input input2" value="mm/dd/yyyy " onblur="if(this.value=='') this.value='mm/dd/yyyy '" onFocus="if(this.value =='mm/dd/yyyy ' ) this.value=''"></div>
							<div class="bg right"><input type="text" name="waktut" class="input input2" value="12:00am" onblur="if(this.value=='') this.value='12:00am'" onFocus="if(this.value =='12:00am' ) this.value=''"></div>
						</div>
					</div>
					<div class="wrapper">
						<p>Penumpang:</p>
						<div class="bg left"><input type="text" name="penumpang" class="input input2" value="# passengers" onblur="if(this.value=='') this.value='# passengers'" onFocus="if(this.value =='# passengers' ) this.value=''"></div>
						<a href="#" class="button2" onClick="document.getElementById('form_1').submit()">SUBMIT</a>
					</div>
				</form>
				<h2>Recent News</h2>
